# CChain - Decentralized File Storage System

A beginner-friendly blockchain-based file storage application built with React, Ethereum (Ganache), and IPFS.
...
| ---------------- | ----------------- | ---------------------------------------------- |
| **General User** | MetaMask Wallet   | Upload, list, download, delete their own files |
...
│
├── ipfs/
│   └── ipfsClient.js          # IPFS upload/download functions
│
├── auth/
...
│   ├── FileList.jsx           # Display list of files
...
│   └── Login.jsx              # Login page (wallet or valuator)
│
├── config/
